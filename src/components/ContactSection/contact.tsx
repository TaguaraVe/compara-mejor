...
export const Contact = () => {
  return (
    ...
    >
      ...
      <div className="w-full max-w-4xl bg-[#EBF5FF] px-2 md:px-10 lg:px-8 py-8 mx-auto mb-8 rounded-lg text-lg">
        <p className="mb-4 w-4/5 mx-auto text-2xl">
      ...
      <div className="w-full max-w-4xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 text-black text-lg">
        <div className="grid grid-cols-1 px-2 md:px-10 py-4  gap-4 bg-[#EBF5FF] rounded-lg">
          <div className="flex items-center">
            ...
            <div className="flex flex-col">
              ...
              <span>ventas@taguaradigital.com</span>
            </div>
          </div>
        </div>
        <div className="grid grid-cols-1 px-2 md:px-10 py-4  gap-4 bg-[#EBF5FF] rounded-lg">
